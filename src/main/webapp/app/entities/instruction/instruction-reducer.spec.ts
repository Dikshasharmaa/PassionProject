...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTRUCTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSTRUCTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSTRUCTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INSTRUCTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INSTRUCTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSTRUCTION actions', async () => {
      const arg = 42666;
